...
This guide covers every way to install Ferry on your Android TV or Fire TV device.
...
Find **Ferry** in your app list and launch it.
...
```bash
git clone https://github.com/mazer666/Ferry.git
cd Ferry
...
./gradlew assembleGoogletvRelease -Pferry.castAppId=<APP_ID>
...
1. Launch Ferry — the **HomeScreen** appears showing three service cards
