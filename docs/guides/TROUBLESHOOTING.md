...
**Cause 4: Ferry service is stopped**
...
- Apple blocks mirroring of protected content by design. This is not a Ferry limitation.
...
- Check logcat: `adb logcat -s Ferry` — look for "MediaCodec" errors.
...
2. Restart the Ferry service (HomeScreen → Restart button).
...
2. Try reinstalling: `adb uninstall com.ferry.receiver.googletv` then install again.
...
Open a GitHub Issue at `https://github.com/mazer666/Ferry/issues` with:
- Your TV model and OS version
- The protocol you were trying to use
- A description of what happened
- `adb logcat -d | grep Ferry` output
