...
- [x] `FerryService.kt` — ForegroundService with start/stop/restart
...
**Definition of Done:**
- macOS sees Ferry within 3s (AC-2.1)
...
- [x] GitHub Release with GoogleTV + FireTV APKs ([v1.0.0-beta.1](https://github.com/mazer666/Ferry/releases/tag/v1.0.0-beta.1))
