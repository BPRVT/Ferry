...
/**
 * ServiceState — Represents the lifecycle state of the FerryService.
 *
 ...
 *
 * HOW: Emitted by [FerryService] via a broadcast or LiveData.
 ...
 * emits [ProtocolState] changes that are aggregated by [FerryService].
 */
