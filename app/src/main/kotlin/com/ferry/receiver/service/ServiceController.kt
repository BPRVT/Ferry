...
/**
 * ServiceController — Provides a clean API to start, stop, and restart the FerryService.
 *
...
object ServiceController {
    ...
    /**
     * Starts the FerryService if it is not already running.
     *
    ...
    fun start(context: Context) {
        ...
        val intent = buildIntent(context, FerryService.ACTION_START)
        startForegroundServiceCompat(context, intent)
    }

    /**
     * Stops the FerryService.
     *
    ...
    fun restart(context: Context) {
        ...
        val intent = buildIntent(context, FerryService.ACTION_RESTART)
        startForegroundServiceCompat(context, intent)
    }
     ...
     * @param action  One of [FerryService.ACTION_START], ACTION_STOP, ACTION_RESTART.
     */
    private fun buildIntent(context: Context, action: String): Intent =
        Intent(context, FerryService::class.java).apply { this.action = action }
}
