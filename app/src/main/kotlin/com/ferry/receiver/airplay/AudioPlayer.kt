...
class AudioPlayer {
    ...
    private var alac: com.ferry.receiver.airplay.handshake.AlacDecoder? = null
    ...
    fun initialize(
        ...
        if (codec == AudioCodec.ALAC) {
            alac = runCatching {
                com.ferry.receiver.airplay.handshake.AlacDecoder(sampleRate, channels, alacFramesPerPacket)
