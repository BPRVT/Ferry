...
import com.ferry.receiver.airplay.handshake.AirPlayNtpClient
import com.ferry.receiver.airplay.handshake.AudioStreamServer
import com.ferry.receiver.airplay.handshake.BufferedAudioServer
import com.ferry.receiver.airplay.handshake.MirrorStreamServer
 ...
 *
 * HOW: [FerryService] creates this receiver and calls [start]/[stop].
 ...
 *
 * State changes are reported via [onStateChanged] to [FerryService].
 *
 * Example:
...
class AirPlayReceiver(
     ...
     * ([FerryService]) uses this to update the [ActiveConnection] and notification
    ...
    private val pairingStore = com.ferry.receiver.airplay.handshake.PairingStore(context)
     ...
     *
     * MUST be called when [FerryService] stops or is destroyed.
     */
    fun stop() {
    ...
    private fun onStreamingStarted(session: SessionDescription) {
        ...
        scope.launch {
            try {
                ...
                emitNowPlaying()
                // Notify FerryService of the sender name BEFORE emitting CONNECTED,
