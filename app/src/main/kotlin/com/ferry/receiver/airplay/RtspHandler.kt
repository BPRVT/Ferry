...
import com.ferry.receiver.airplay.handshake.FairPlay
import com.ferry.receiver.airplay.handshake.InfoResponder
import com.ferry.receiver.airplay.handshake.PairingKeys
import com.ferry.receiver.airplay.handshake.PairingSession
import com.ferry.receiver.airplay.handshake.PlistCodec
...
open class RtspHandler(
    ...
    private val onPlaybackInfo: () -> com.ferry.receiver.airplay.PlaybackInfo? = { null },
    ...
    @Volatile private var legacyPin: com.ferry.receiver.airplay.handshake.LegacyPairSetupPin? = null
     ...
     * could otherwise fail with EADDRINUSE, leaving Ferry advertising over mDNS while port 7000
    ...
    private fun newSrpSession() {
        ...
        onShowPin(pin)
        legacyPin = com.ferry.receiver.airplay.handshake.LegacyPairSetupPin(pin, PairingKeys.get(context).edPublic)
    }
    ...
    companion object {
        ...
        private const val SESSION_ID = "FerrySession"
