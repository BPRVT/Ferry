...
/**
 * FerryApp — The Application class for Ferry.
 *
 ...
 * at startup.
 *
 * HOW: This class is referenced in AndroidManifest.xml via android:name=".FerryApp".
 ...
 *   The app starts → Android creates FerryApp → onCreate() runs → Timber is ready.
 */
