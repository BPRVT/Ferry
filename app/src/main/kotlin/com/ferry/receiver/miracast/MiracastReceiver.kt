package com.ferry.receiver.miracast
...
import com.ferry.receiver.airplay.RtspRequest
import com.ferry.receiver.airplay.RtspRequestReader
import com.ferry.receiver.airplay.RtspResponse
...
class MiracastReceiver(
    ...
    companion object {
        ...
        private const val SERVICE_INSTANCE_NAME = "Ferry"
...
internal class WfdRtspServer(
    ...
    companion object {
        ...
        private const val WFD_SESSION_ID = "FerryWfdSession"
    }
}
