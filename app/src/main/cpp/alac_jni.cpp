 ...
 *
 * Backs com.ferry.receiver.airplay.handshake.AlacDecoder.
 */
#include <jni.h>
#include <cstdint>
#include <cstring>
...
Java_com_ferry_receiver_airplay_handshake_AlacDecoder_nativeInit(JNIEnv *env, jobject, jbyteArray cookie) {
...
Java_com_ferry_receiver_airplay_handshake_AlacDecoder_nativeDecode(
...
Java_com_ferry_receiver_airplay_handshake_AlacDecoder_nativeRelease(JNIEnv *, jobject, jlong handle) {
    if (handle == 0) return;
